...
interface DealerObserver {
    ...
    fun notifyAction(context: GameContext<SeatName, Board>, playerAction: PlayerAction) {}
}
...
class MultipleDealerObserver(private val observers: Set<DealerObserver>): DealerObserver {
    ...
    override fun notifyAction(context: GameContext<SeatName, Board>, playerAction: PlayerAction) {
